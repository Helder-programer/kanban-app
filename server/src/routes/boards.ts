...
router.get('/favorites', authMiddleware, (req, res) => boardController.getFavorites(req, res));
router.put('/favorites', authMiddleware, (req, res) => boardController.updateFavoritesBoardsPositions(req, res));
